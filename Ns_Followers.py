...
class Ns_Followers:
    def __init__(self):
        ...
        self.__userid='66787958744' #Enter UserID Here
        self.__username='hzncu_' #Enter UserName Here' #Enter SessionID Here
        self._session='66787958744:Y56NsObOWDgMPr:27:AYc_2r1WObrUXV7MDN7EXgkgHWZxIhKLKPMBolfJ5w'
